    ...
    return (
      <div className="wizard-container">
        <div className="wizard-step active" style={{ textAlign: 'center' }}>
          <h2 className="wizard-question text-red" style={{ fontSize: '2.5rem' }}>Profile Created!</h2>
          <p className="text-gray text-xl mb-6">You're officially registered on Project Red-Link.</p>
          
          <div className="wizard-buttons flex-align" style={{ justifyContent: 'center', marginTop: '2rem' }}>
            <button className="btn btn-red" onClick={onComplete} style={{ fontSize: '1.2rem', padding: '1rem 2.5rem' }}>Done / Continue</button>
          </div>
        </div>
      </div>
    );
